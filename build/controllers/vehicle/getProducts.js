      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            _context.next = 17;
            return Vehicle.find(findModel).sort((0, _defineProperty2["default"])({}, sortOptions.getFieldName(), sortOptions.getOrder())).skip(pagination.getSkippedItemsCount()).limit(pagination.getPerPage());
